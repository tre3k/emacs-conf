...
(custom-theme-set-faces
 'tre3k-dark
 '(default ((t (:inherit nil :extend nil :stipple nil :background "#343434" :foreground "#e6e3d8" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 128 :width normal :foundry "ABCD" :family "Victor Mono"))))
